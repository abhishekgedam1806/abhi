...
class AzureOpenAIDriver implements AIDriverInterface
{
    protected $provider;
    protected $apiKey;
    protected $model;
    ...
    public function __construct(AIProvider $provider)
    {
        ...
        $this->timeout = $provider->timeout_sec ?: 45;
    }
    ...
    public function generateText(string $prompt, array $options = []): array
    {
        ...
        if (isset($response['error'])) {
            throw new Exception($response['error']['message'] ?? 'Azure OpenAI returned an error.');
        }
    ...
    public function testConnection(): array
    {
        ...
        try {
            ...
            return [
                ...
                'message' => 'Connection Successful. Deployment: ' . $this->model . ' (' . $elapsedMs . 'ms)',
                'model' => $this->model,
