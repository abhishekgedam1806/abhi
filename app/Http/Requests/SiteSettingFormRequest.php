...
class SiteSettingFormRequest extends Request
{
    ...
    public function rules()
    {
        return [
            ...
            'ses_secret' => 'max:100',
            'ses_region' => 'max:100',
            'hero_badge_text' => 'nullable|max:150',
            'hero_title_line1' => 'nullable|max:150',
            'hero_title_line2' => 'nullable|max:150',
            'hero_subtitle' => 'nullable|max:255',
            'hero_stat1_number' => 'nullable|max:30',
            'hero_stat1_label' => 'nullable|max:60',
            'hero_stat2_number' => 'nullable|max:30',
            'hero_stat2_label' => 'nullable|max:60',
            'hero_stat3_number' => 'nullable|max:30',
            'hero_stat3_label' => 'nullable|max:60',
            'hero_hired_text' => 'nullable|max:100',
