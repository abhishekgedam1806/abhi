...
class ContactController extends Controller
{
    ...
    public function postContact(ContactFormRequest $request)
    {
        ...
        try {
            ...
            \Log::warning('Contact message mail delivery delayed: ' . $e->getMessage());
        }

        flash(__('Thank you! Your inquiry has been submitted successfully. Our support team will get in touch with you shortly.'))->success();
