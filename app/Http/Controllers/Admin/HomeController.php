...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        // Count only truly live jobs (active AND not expired)
        $totalActiveJobs = Job::where('is_active', 1)->notExpire()->count();
        $totalFeaturedJobs = Job::where('is_featured', 1)->notExpire()->count();
