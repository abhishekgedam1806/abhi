        ...
        return Datatables::of($cmsContent)
                        ...
                        ->addColumn('action', function ($cmsContent) {
                            ...
                            <div class="cms-action-wrap">
                                <a href="' . route('edit.cmsContent', ['id' => $cmsContent->id]) . '" class="btn-cms-edit" title="Edit content">
                                    <i class="fa fa-pencil"></i> Edit
                                </a>
                                <button type="button" onclick="delete_cmsContent(' . $cmsContent->id . ');" class="btn-cms-delete" title="Delete content">
