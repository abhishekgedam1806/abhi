...
Route::post('update-user-image', 'UserController@updateUserImage')->name('update.user.image');
...
Route::post('store-front-profile-cv/{id}', 'UserController@storeFrontProfileCv')->name('store.front.profile.cv');
...
Route::get('onboarding', 'User\OnboardingController@index')->name('onboarding');
Route::post('onboarding/save-step', 'User\OnboardingController@saveStep')->name('onboarding.save.step');
Route::get('onboarding/complete', 'User\OnboardingController@completeOnboarding')->name('onboarding.complete');
Route::get('api/skills-search', 'User\OnboardingController@searchSkills')->name('api.skills.search');
Route::get('api/cities-search', 'User\OnboardingController@searchCities')->name('api.cities.search');

/* ******** Onboarding Education AJAX Endpoints ************ */
Route::get('api/onboarding/courses',          'User\OnboardingController@getCourses')->name('api.onboarding.courses');
Route::get('api/onboarding/specializations',  'User\OnboardingController@getSpecializations')->name('api.onboarding.specializations');
Route::get('api/onboarding/skill-suggestions','User\OnboardingController@getSkillSuggestions')->name('api.onboarding.skill_suggestions');
Route::get('api/onboarding/role-suggestions', 'User\OnboardingController@getRoleSuggestions')->name('api.onboarding.role_suggestions');
Route::get('api/onboarding/institutions',     'User\OnboardingController@searchInstitutions')->name('api.onboarding.institutions');
