...
Route::get('jobs-in-{city_slug}/{category_slug}', 'Job\JobController@jobsByCategoryAndCity')->name('jobs.category.city');
Route::get('jobs/{category_slug}-in-{city_slug}', 'Job\JobController@jobsByCategoryAndCity');
...
Route::post('delete-front-job', 'Job\JobPublishController@deleteJob')->name('delete.front.job');
...
Route::get('get-areas-by-city', 'Job\JobController@getAreasByCity')->name('get.areas.by.city');
