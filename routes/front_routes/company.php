...
Route::post('company-update-application-status', 'Company\CompanyController@updateApplicationStatus')->name('company.update.application.status');
...
/* AI Job Description Optimizer & Grammarly-style Proofreader */
Route::post('company/ai/optimize-job', 'Company\CompanyAIController@optimizeJobDescription')->name('company.ai.optimize_job');
Route::post('company/ai/proofread-job', 'Company\CompanyAIController@proofreadJobDescription')->name('company.ai.proofread_job');
