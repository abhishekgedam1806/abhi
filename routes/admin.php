...
include_once($real_path . 'payment.php');
include_once($real_path . 'ai.php');
include_once($real_path . 'menu_management.php');
include_once($real_path . 'offer.php');
include_once($real_path . 'whatsapp.php');
...
Route::group(['namespace' => 'Admin'], function () {
    ...
    Route::post('/blog/toggle-status/{id}', 'BlogsController@toggleStatus')->name('admin.blog.toggle');
    Route::post('/blog/ai-suggest-seo', 'BlogsController@aiSuggestSeo')->name('admin.blog.ai.seo');
