...
Route::post('bulk-delete-job-experiences', array_merge(['uses' => 'Admin\JobExperienceController@bulkDeleteJobExperiences'], $all_users))->name('bulk.delete.job.experiences');
