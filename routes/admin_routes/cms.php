...
Route::post('bulk-delete-cms', array_merge(['uses' => 'Admin\CmsController@bulkDeleteCms'], $all_users))->name('bulk.delete.cms');
...
Route::post('bulk-delete-cmsContent', array_merge(['uses' => 'Admin\CmsContentController@bulkDeleteCmsContent'], $all_users))->name('bulk.delete.cmsContent');
