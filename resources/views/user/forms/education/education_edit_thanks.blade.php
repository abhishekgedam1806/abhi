<div class="modal-dialog modal-dialog-centered" style="max-width:440px; margin:auto;"> 
    <div class="modal-content custom-profile-modal">
        <div class="modal-header">
            <h4 class="modal-title">{{__('Update Education')}}</h4>
        ...
        <div class="modal-body text-center py-4" style="padding:28px 20px 24px;">
            ...
            <h4 style="font-size:18px; font-weight:700; color:#0F172A; margin:0 0 6px 0;">{{__('Education Updated Successfully')}}</h4>
            <p style="font-size:13.5px; color:#64748B; margin:0;">Your education qualification changes have been saved.</p>
        </div>
