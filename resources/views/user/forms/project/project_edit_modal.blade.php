<div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content custom-profile-modal">
        <form class="form" id="add_edit_profile_project" method="POST" action="{{ route('update.front.profile.project', [$profileProject->id, $user->id]) }}">
            {{ csrf_field() }}
            ...
            <div class="modal-footer" style="padding: 14px 24px; border-top: 1px solid #F1F5F9; background: #FFFFFF; display: flex; justify-content: flex-end; align-items: center; gap: 12px;">
                ...
                <button type="button" class="btn-modal-save" onClick="submitProfileProjectForm();">
                    <i class="fa fa-check"></i> {{__('Save Project')}}
                </button>
            </div>
        </form>
    </div>
