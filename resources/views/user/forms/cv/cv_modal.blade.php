<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content custom-profile-modal">
        <form class="form" id="add_edit_profile_cv" method="POST" action="{{ route('store.front.profile.cv', [$user->id]) }}" enctype="multipart/form-data">
            {{csrf_field()}}
            <input type="hidden" name="id" id="id" value="0"/>
            <div class="modal-header">
                <h4 class="modal-title">{{__('Add CV / Resume')}}</h4>
