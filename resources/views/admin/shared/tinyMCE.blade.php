<?php
$lang = $lang ?? (config('default_lang') ? \MiscHelper::getLang(config('default_lang')) : 'en');
$direction = $direction ?? (\MiscHelper::getLangDirection($lang));
?>
...
<script>
tinymce.init({
    selector: '#industry,#faq_question,#faq_answer,#slider_description,#description',
    height: 300,
    forced_root_block: '',
    language: '{{ $lang }}',
