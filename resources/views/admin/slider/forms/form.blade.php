...
<div class="form-body">        
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'slider_image') !!}">
        {!! Form::label('slider_image', 'Promotional Banner Image', ['class' => 'bold']) !!}
        <p class="help-block" style="margin-top: 2px; margin-bottom: 6px; font-size: 12.5px; color: #64748B;">
            <strong>Recommended Size:</strong> 1600 &times; 640 px (Aspect Ratio <strong>2.5 : 1</strong>) &bull; Supported formats: JPG, JPEG, PNG, WEBP
        </p>
        {!! Form::File('slider_image', array('class'=>'form-control', 'id'=>'slider_image', 'accept'=>'image/*')) !!}
